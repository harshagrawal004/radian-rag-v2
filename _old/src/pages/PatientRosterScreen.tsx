...
const patients: Patient[] = [
  { id: "P1-Sanjeev-Malhotra", name: "Sanjeev Malhotra", age: 58, condition: "Cardiac & Diabetes", available: true },
  { id: "P2-Priya-Sharma", name: "Priya Sharma", age: 45, condition: "Hypertension", available: false },
  { id: "P3-Amit-Patel", name: "Amit Patel", age: 62, condition: "Renal Disease", available: false },
  { id: "P4-Lakshmi-Nair", name: "Lakshmi Nair", age: 51, condition: "Thyroid", available: false },
];
