...
CREATE TABLE IF NOT EXISTS public.as_rag_v3_test (
...
CREATE INDEX IF NOT EXISTS as_rag_v3_test_run_id_idx ON public.as_rag_v3_test(run_id);
CREATE INDEX IF NOT EXISTS as_rag_v3_test_test_id_idx ON public.as_rag_v3_test(test_id);
CREATE INDEX IF NOT EXISTS as_rag_v3_test_created_at_idx ON public.as_rag_v3_test(created_at DESC);
